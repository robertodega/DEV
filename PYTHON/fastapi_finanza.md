...
&& touch .gitignore .env database.py models.py main.py const.py static/css/bootstrap.css static/css/custom.css static/js/bootstrap.js static/js/jquery.js static/js/custom.js templates/base.html templates/navbar.html templates/selector.html templates/footer.html templates/index.html templates/overview.html templates/bills.html templates/income.html templates/loan.html
...
- nano const.py
        ...
        selector_values = {current_year - 2, current_year - 1, current_year, current_year + 1}
...
- nano models.py
        ...
        class Utente(Base):
            __tablename__ = "utenti_test_fastapi"
...
- nano main.py
        ...
        #     utenti = db.query(models.Utente).all()
        #     return utenti
...
- nano templates/base.html
        ...
        <html>
            <head>
                ...
                <script src="{{ url_for('static', path='js/fontawesome.css') }}"></script>
            ...
            <body class="is-preload">
                <div id="wrapper">
                    <div id="main">
                        <div class="inner">
                            <header id="header">
                                <div class="header-div"><a href="./" class="logo">
                                    <strong>Finanza</strong> by RobDega</a> 
                                    [ {% if year_selector %}<strong>{{ year_selector }}</strong>{% else %}<strong>{{ const.current_year }}</strong>{% endif%} ]</div>
                                <div class="header-div header-path-div">
                                    <a href='./'><span class="curpage-span">Home</span></a>
                                    <span class="curpage-span">{% if curpage != 'Home' %} > {{ curpage }} {% endif %}</span>
                                </div>
                            </header>
                            <section id="banner">
                                <div class="content">
                                    <div class="content-div">
                                        <h1>{{ const.website_title }}</h1>
...
- nano templates/selector.html

        <section id="selector-section" class="alt">
            <form id="selector-form" name="selector-form" method="post" action="./">
                <select class="interactive-element" id="year_selector" name="year_selector" onchange="$('#selector-form').submit()">
                    {% for item in const.selector_values %}
                        {% if not year_selector %}
                            {% if item == const.current_year %}
                                {% set selected = 'selected' %}
                            {% else %}
                                {% set selected = '' %}
                            {% endif %}
                        {% else %}
                            {% if item == year_selector %}
                                {% set selected = 'selected' %}
                            {% else %}
                                {% set selected = '' %}
                            {% endif %}
                        {% endif %}
                    <option id="opt_{{ item }}" value="{{ item }}" {{ selected }} >{{ item }}</option>
                    {% endfor %}
                </select>
            </form>
        </section>
...
- nano template/footer.html
        ...
        <footer id="footer">
            <p class="copyright">&copy; Finanza by <a href="http://www.robertodegaetano.it/" target="_blank">RobDega</a>.</p>
        </footer>
...
#   app run
- python3 -m venv finanzaEnv
- Windows:
    -   source finanzaEnv/Scripts/activate
- Linux:
    -   finanzaEnv/bin/activate
