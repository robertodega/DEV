...
- nano const.py
        ...
        website_title = "FastApi Newsfeed"
        rootpath = "./"
...
- nano main.py
        ...
        def api_search(apiKeyField: str = Form(...), searchField: str = Form(...)):
            res = []
            response = {}
            tot_records = 0
...
- pip3 install fastapi uvicorn jinja2 requests python-multipart

- uvicorn main:app --reload
- http://127.0.0.1:8000

- cd .. && rm -rf fastapi_newsfeed && clear && ls -la
