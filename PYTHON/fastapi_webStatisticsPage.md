...
- nano const.py
        ...
        invited_title = "Invitato"
        uninvited_title = "Non Invitato"
        confirmed_title = "Confermato"
        unconfirmed_title = "Non Confermato"
        unknown_title = "In Sospeso"
...
- nano database.py
        ...
        DB_PORT = os.getenv("DB_PORT", "3306") # Default 3306 se non specificato
        DB_NAME = os.getenv("DB_NAME")

        # Composizione della stringa di connessione (Connection String)
...
- nano models.py
        ...
        class GuestConfirm(Base):
            __tablename__ = "guest_confirm"
        ...
        class GuestOffers(Base):
            __tablename__ = "guest_offers"
...
- nano main.py
        ...
        async def submit_form(request: Request, db: Session = Depends(get_db)):
            ...
            redirect_url = form_data.get("curpage_field", "./")
...
- nano templates/updateForm.html
        ...
        <form id="update-form" name="update-form" method="post" action="./" ref="update">
            <input type="hidden" id="curpage_field" name="curpage_field" value="{{ curpage }}" />
            <input type="hidden" id="id_field" name="id_field" value="" />
            <input type="hidden" id="column_field" name="column_field" value="" />
            <input type="hidden" id="value_field" name="value_field" value="" />
        </form>
        ...
        <table border="1">
            <thead>
                <tr>
                    ...
                    <th>Cognome</th>
                    <th>Grado</th>
                    <th class="desktop">Invitato</th>
                    <th class="desktop">Confermato</th>
                    <th class="desktop">Presente</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td class="table_cell desktop">
                        {% if result.invite %}
                        <img class="ico_img ico_act_img" id="{{ result.id }}" functionality="update" ref="invite" value="1" src="{{ url_for('static', path='img/ok.png') }}" alt="{{ adultImg }}" title="{{ const.invited_title }}">
                        {% else %}
                        <img class="ico_img ico_act_img" id="{{ result.id }}" functionality="update" ref="invite" value="0" src="{{ url_for('static', path='img/ko.png') }}" alt="{{ adultImg }}" title="{{ const.uninvited_title }}">
                        {% endif %}
                    </td>
                    <td class="table_cell desktop">
                        {% if result.confirmed %}
                        <img class="ico_img ico_act_img" id="{{ result.id }}" functionality="update" ref="confirmed" value="1" src="{{ url_for('static', path='img/ok.png') }}" alt="{{ adultImg }}" title="{{ const.confirmed_title }}">
                        {% else %}
                        <img class="ico_img ico_act_img" id="{{ result.id }}" functionality="update" ref="confirmed" value="0" src="{{ url_for('static', path='img/ko.png') }}" alt="{{ adultImg }}" title="{{ const.unconfirmed_title }}">
                        {% endif %}
                    </td>
                    <td class="table_cell desktop">
                        {% if result.confirmed %}
                        {% if result.presence %}
                        <img class="ico_img ico_act_img" id="{{ result.id }}" functionality="update" ref="presence" value="1" src="{{ url_for('static', path='img/ok.png') }}" alt="{{ adultImg }}" title="{{ const.present_title }}">
                        {% else %}
                        <img class="ico_img ico_act_img" id="{{ result.id }}" functionality="update" ref="presence" value="0" src="{{ url_for('static', path='img/ko.png') }}" alt="{{ adultImg }}" title="{{ const.absent_title }}">
                        {% endif %}
                        {% else %}
                        <img class="ico_img" id="{{ result.id }}" ref="presence" value="" src="{{ url_for('static', path='img/question.png') }}" alt="{{ adultImg }}" title="{{ const.unknown_title }}">
                        {% endif %}
                    </td>
                </tr>
                {% else %}
                <tr>
                    <td colspan="3">Nessun ospite trovato nel database.</td>
                </tr>
                {% endfor %}
            </tbody>
        </table>
              ...
              case "update":
                ...
                //   const newValueDbField = $(this).attr("value") == '1' ? "false" : "true";
                  if (
                    ...
                    $("#id_field").val($(this).attr("id"));
                    $("#column_field").val($(this).attr("ref"));
                    $("#value_field").val(newValueDbField);
                    $("#update-form").submit();
                  }
                }
                break;
